...
########### alignment
fq1 <- list.files(path="/group/jrigrp7/jyang/methylation/largedata/wgbs_fq", pattern="R1_trimmed.fastq.gz$", full.names = TRUE)
fq2 <- list.files(path="/group/jrigrp7/jyang/methylation/largedata/wgbs_fq", pattern="R2_trimmed.fastq.gz$", full.names = TRUE)
