...
# in this example these are represented by the R objects: 
# sample1_r1, sample1_r2, sample1_r3, sample1_r4, sample2_r1, sample2_r2
...
counts.low <- subset(counts.low, rowSums(counts.low) >  4) 
# this is a also user-defined parameter; lCOMETs have typically low counts
...
write.table(summary(de.low <- decideTestsDGE(et.low, p=0.05, adjust="BH")), 
            "summary.low.methylation.DMB.100K.txt", sep="\t", quote=F)                                                                         
